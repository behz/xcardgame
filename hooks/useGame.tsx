...
const useGame = () => {
  ...
  const joinGame = async () => {
    ...
    if (match) {
      ...
      setOpponentSelectedCard(
        match.player1 == userId ? match.player2Card : match.player1Card
      );
      setMySelectedCard(
        match.player1 == userId ? match.player1Card : match.player2Card
      );
      ...
      .on(
        ...
        (payload) => {
          ...
          if (
            ...
            setOpponentId(
              isFirstPlayer ? matchData.player2 : matchData.player1
            );
          }
          if (
            !opponentSelectedCard &&
            matchData &&
            (matchData.player2Card || matchData.player1Card)
          ) {
            setOpponentSelectedCard(
              isFirstPlayer ? matchData.player2Card : matchData.player1Card
            );
          }
        }
      )
